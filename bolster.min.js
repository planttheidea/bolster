...
g=!(!a.canvas.getContext||!a.canvas.getContext("2d")),y=!!d.documentElement.classList,z;z=a.div.style.animationName?!0:b(["WebkitAnimationName","MozAnimationName","OAnimationName","msAnimationName","KhtmlAnimationName"]);var A=c("width","calc(100% - 10px)"),v=b(["columnCount","webkitColumnCount","MozColumnCount"]),B=b(["boxReflect","WebkitBoxRefect"]),N=!!a.style.styleSheet,m=!!f.CustomEvent,O=!!("draggable"in a.div),w=a.div.addEventListener,P=c("display","flex"),C=!!("geolocation"in navigator),D=
...
Ca=n("::first-letter"),Da=n("::first-line"),Ea=n(":link"),Fa=n(":visited"),L=function(){try{for(var a=["radial-gradient","-webkit-radial-gradient","-moz-radial-gradient","-o-radial-gradient"],g=!1,b=a.length;b--;)if(c("background",a[b]+"(rgb(0,0,0) 0%,rgb(255,255,255) 100%)")){g=!0;break}return g?g:c("background","-webkit-gradient(radial, center center, 0px, center center, 100%, from(rgb(0,0,0)), to(rgb(255,255,255)))")}catch(e){return!1}}(),Ga=c("background-color","rgba(0,0,0,0)"),F;try{f.sessionStorage.setItem("test",
"test"),f.sessionStorage.removeItem("test"),F=!0}catch(Ta){F=!1}var Ha=!!(d.createElementNS&&-1<d.createElementNS("http://www.w3.org/2000/svg","animateMotion").toString().indexOf("SVG")),Ia=!(!d.createElementNS||!d.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect),Ja=b(["textShadow"]),Ka=!!("ontouchstart"in d.documentElement||f.navigator.msMaxTouchPoints),I=b(["transform","WebkitTransform","MozTransform","msTransform","OTransform"]),M=function(){if(I)try{for(var a=["transform","WebkitTransform",
...
canvas:function(){return g},classList:function(){return y},cssAnimation:function(){return z},cssCalc:function(){return A},cssColumn:function(){return v},cssReflection:function(){return B},customEvent:function(){return m},dragAndDrop:function(){return O},eventListener:function(){return w},flexbox:function(){return P},geolocation:function(){return C},getBoundingClientRect:function(){return D},getElementsByClassName:function(){return G},gradient:function(){return{linear:K,radial:L}},hashchange:function(){return H},
history:function(){return Q},hsla:function(){return R},html5Attribute:function(){return{autocomplete:T,autofocus:U,list:aa,max:ba,min:ca,multiple:da,pattern:ga,placeholder:ha,required:ja,step:la}},html5Input:function(){return{color:V,date:W,dateTime:X,dateTimeLocal:Y,email:Z,month:ea,number:fa,range:ia,search:ka,tel:ma,time:na,url:oa,week:pa}},indexedDB:function(){return S},json:function(){return qa},linearGradient:function(){return K},localStorage:function(){return E},mediaQueries:function(){return ra},
opacity:function(){return sa},pageOffset:function(){return ta},postMessage:function(){return ua},pseudoClass:function(){return{active:va,after:wa,before:ya,focus:Aa,hover:Ba,link:Ea,visited:Fa}},pseudoElement:function(){return{after:xa,before:za,firstLetter:Ca,firstLine:Da}},radialGradient:function(){return L},rgba:function(){return Ga},sessionStorage:function(){return F},smil:function(){return Ha},storage:function(){return{local:E,session:F}},svg:function(){return Ia},textShadow:function(){return Ja},
touchEvents:function(){return Ka},transform:function(){return{twoD:I,threeD:M}},transform2d:function(){return I},transform3d:function(){return M},transition:function(){return La},video:function(){return Ma},videoMP4:function(){return Na},videoOGG:function(){return Oa},videoWebM:function(){return Pa},webGL:function(){return Qa},webSocket:function(){return Ra}}}(),v=function(){function a(a){if(0<e[a])for(var b in c)if(c[b])for(var d=c[b].length;d--;)c[b][d].token!==e[a]||c[b][d].persistent||(delete e[a],
...
x=m(q),g=function(){return f.location.hash.replace("#","")},y=g,z=f.location.hostname||f.location.host,A=f.location.search.substr(1),J=function(){for(var a=A.split("&"),b={},g=0,c=a.length;g<c;g++){var e=a[g].split("=");0<e[0].length&&(b[e[0]]=e[1])}return b},B=J();c.off(".bolster.setWindowAttributes").on({"webkitfullscreenchange.bolster.setWindowAttributes mozfullscreenchange.bolster.setWindowAttributes fullscreenchange.bolster.setWindowAttributes MSFullscreenChange.bolster.setWindowAttributes":function(){r=
...
{height:a.height,naturalHeight:d.naturalHeight||d.height,naturalWidth:d.naturalWidth||d.width,percentComplete:Math.floor(100*(b+1)/c),src:a.src,width:a.width})},d.src=a.src)}},naturalDimensions:{height:function(a){var b=new Image;b.onload=function(){return b.naturalHeight||b.height};b.src=a.src},width:function(a){var b=new Image;b.onload=function(){return b.naturalWidth||b.width};b.src=a.src}}};h.extend({document:function(a,b){return a?H[a](b):H.document()},localStorage:function(){return D.local(arguments)},
publish:function(a){return v.publish(a)},removeStorage:function(){return D.remove(arguments)},sessionStorage:function(){return D.session(arguments)},subscribe:function(a){return v.subscribe(a)},supports:function(a){return G[a]()},unsubscribe:function(a){return v.unsubscribe(a)},window:function(a,b){return a?C[a](b):C.window()}});h.fn.extend({active:function(a){return this.hasClass(a||"active")},activate:function(a,b){a=a||"active";return b?this.deactivate(a,b).addClass(a):this.deactivate(a).addClass(a)},
boundingBox:function(a){if(a){var b;switch(h.type(a)){case "string":b=m.clientRect(this)[a];break;case "array":b={};for(var c=0,d=a.length;c<d;c++)b[a[c]]=m.clientRect(this)[a[c]];break;default:b=w}return b}return m.clientRect(this)},dataFilter:function(a,b){return"object"===h.type(a)?this.filter(function(){var b=h(this).data(),d,f;for(f in a)if(d=b.hasOwnProperty(f)&&b[f]===a[f],!d)break;return d}):this.filter(function(){return h(this).data(a)===val})},deactivate:function(a,b){a=a||"active";b?this.parents("."+
...
"-webkit-user-select":"none","-khtml-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"});return this},unstyle:function(a){switch(h.type(a)){case "string":return this.css(a,"");case "array":for(var b={},c=a.length;c--;)b[a[c]]="";return this.css(b);case "undefined":return this.removeAttr("style");default:return p("Parameter passed in is not of appropriate type; processing aborted."),this}}})})(window.jQuery,window,document);
