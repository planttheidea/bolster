...
!a.canvas.getContext("2d")),p=!!b.documentElement.classList,q;q=a.div.style.animationName?!0:k(["WebkitAnimationName","MozAnimationName","OAnimationName","msAnimationName","KhtmlAnimationName"]);var z=f("width","calc(100% - 10px)"),s=k(["columnCount","webkitColumnCount","MozColumnCount"]),L=k(["boxReflect","WebkitBoxRefect"]),t=!!a.style.styleSheet,M=!!g.CustomEvent,x=!!("draggable"in a.div),N=a.div.addEventListener,y=f("display","flex"),C=!!("geolocation"in navigator),O=!!b.getElementsByClassName,
...
before:xa,firstLetter:Aa,firstLine:Ba}},radialGradient:function(){return G},rgba:function(){return Ea},sessionStorage:function(){return B},smil:function(){return Fa},storage:function(){return{local:A,session:B}},svg:function(){return Ga},textShadow:function(){return Ha},touchEvents:function(){return Ia},transform:function(){return{twoD:E,threeD:H}},transform2d:function(){return E},transform3d:function(){return H},transition:function(){return Ja},video:function(){return{mp4:I,ogg:J,webM:K}},videoMP4:function(){return I},
...
return this},unsubscribe:function(c){switch(l.type(c.name)){case "string":a(c.name);break;case "array":for(var b=c.name.length;b--;)a(c.name[b]);break;default:p("Name passed is not of valid type.")}return this}}}(),x=function(){function a(a){return{fullscreenActive:m,fullscreenElement:n,hash:D,height:h,hostname:s,href:v,page:w,querystring:t,scrollTop:c,width:e}}function k(){D=g.location.hash.replace("#","")}var f=l(g),h=f.height(),e=f.width(),c=f.scrollTop(),u=b.createElement("video"),r=function(){return u.requestFullScreen?
...
b.height};b.src=a.src},width:function(a){var b=new Image;b.onload=function(){return b.naturalWidth||b.width};b.src=a.src}}};l.extend({document:function(a,b){return a?C[a](b):C.document()},localStorage:function(){return y.local(arguments)},pledge:function(a){if("function"===l.type(a))return(new Pledge).start(a);p("Must pass function into $.pledge.")},postpone:function(){return new Postpone},publish:function(a){return q.publish(a)},removeStorage:function(){return y.remove(arguments)},sessionStorage:function(){return y.session(arguments)},
subscribe:function(a){return q.subscribe(a)},supports:function(a){return s[a]()},unsubscribe:function(a){return q.unsubscribe(a)},window:function(a,b){return a?x[a](b):x.window()}});l.fn.extend({active:function(a){return this.hasClass(a||"active")},activate:function(a,b){a=a||"active";return b?this.deactivate(a,b).addClass(a):this.deactivate(a).addClass(a)},deactivate:function(a,b){a=a||"active";b?this.parents("."+b).find("."+a).removeClass(a):this.parent().find("."+a).removeClass(a);return this},
