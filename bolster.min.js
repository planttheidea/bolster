...
start:function(a){if("function"===h.type(a)){var b=this;f.setTimeout(function(){a.call(b)},0);return b}},wait:function(a,b){var c=this,e;switch(h.type(b)){case "boolean":e=b;break;case "function":e=b();break;default:e=!0}return c.proceed(function(b){f.setTimeout(function(){e?c.resolve.call(c,b):c.reject.call(c,"Test did not pass.")},a)})}};h.extend({pledge:function(d){if("function"===h.type(d))return(new a).start(d);l("Parameter passed is not a valid type for this method.")},postpone:function(){return new e}})})();
h.extend({publish:function(a){return m.publish(a)},subscribe:function(a){return m.subscribe(a)},supports:function(a){return r[a]()},unsubscribe:function(a){return m.unsubscribe(a)},window:function(a){return s[a]()}});h.fn.extend({active:function(a){return this.hasClass(a||"active")},activate:function(a,e){a=a||"active";return e?this.deactivate(a,e).addClass(a):this.deactivate(a).addClass(a)},deactivate:function(a,e){a=a||"active";e?this.parents(e).find("."+a).removeClass(a):this.parent().find("."+
a).removeClass(a);return this},imgLoad:function(a,e){var d=this.length;return e&&0<e?this.each(function(b){var c=this;f.setTimeout(function(){pluginFuncs.loadImg(c,b,d,a)},e*b)}):this.each(function(b){pluginFuncs.loadImg(this,b,d,a)})},unselectable:function(a){(a?this:this.add($self.find("*"))).attr({unselectable:"on"}).css({"-webkit-touch-callout":"none","-webkit-user-select":"none","-khtml-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"});return this},
unstyle:function(a){switch(h.type(a)){case "string":return this.css(a,"");case "array":for(var e={},d=a.length;d--;)e[a[d]]="";return this.css(e);case "undefined":return this.removeAttr("style");default:return throwwError("Parameter passed in is not of appropriate type; processing aborted."),this}}})})(window,document,jQuery);
