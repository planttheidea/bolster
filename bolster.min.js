 ...
 *
*/
(function(g,e,k){var n=function(a){throw Error(a);},v=function(){var a={audio:e.createElement("audio"),canvas:e.createElement("canvas"),document:e.documentElement||e.body,div:e.createElement("div"),input:e.createElement("input"),p:e.createElement("p"),style:e.createElement("style"),video:e.createElement("video")},b=function(c){try{for(var b=!1,d=c.length;d--;)if(c[d]in a.document.style){b=!0;break}return b}catch(e){return!1}},d=function(c,b){try{var d=a.div.style[c];a.div.style[c]=b;return d!==a.div.style[c]?
(a.div.style[c]="",!0):!1}catch(e){return!1}},h=function(c){return c in a.input},f=function(c){try{var b=a.input.type;a.input.type=c;return b!==a.input.type?(a.input.type="text",!0):!1}catch(d){return!1}},c=function(c){try{var b=e.head||e.getElementsByTagName("head")[0],d=a.style.sheet||a.style.styleSheet;a.style.type="text/css";b.appendChild(a.style);return d&&c?(E?function(a){d.cssText=a+" { }";return 0!==d.cssText.length&&!/unknown/i.test(d.cssText)&&0===d.cssText.indexOf(a)}:function(a){try{d.insertRule(a+
...
videoOGG:function(){return C},videoWebM:function(){return D},webGL:function(){return Ia},webSocket:function(){return Ja}}}(),l=function(){function a(a){if(0<e[a])for(var b in d)if(d[b])for(var f=d[b].length;f--;)d[b][f].token===e[a]&&(delete e[a],d[b].splice(f,1))}function b(a,b,e){"array"!==k.type(d[a])&&(d[a]=[]);d[a].push({token:b,func:e})}var d={},e={},f=-1;return{getID:function(a){return e[a.name]},publish:function(a){var b=a.data||{},e,f;if(!d[a.topic])return!1;for(f=(e=d[a.topic])?e.length:
0;f--;)e[f].func(b,a.topic);return this},subscribe:function(c){if("string"!==k.type(c.name))return n("Name passed is not a string."),!1;e[c.name]&&a(c.name);switch(k.type(c.topic)){case "string":b(c.topic,c.token,c.fn);break;case "array":for(var d=c.topic.length;d--;)b(c.topic[d],c.token,c.fn);break;case "undefined":n("Must provide a topic to subscribe to.");break;default:n("Invalid topic type, must be either string or array.")}e[c.name]=++f;return this},unsubscribe:function(b){switch(k.type(b.name)){case "string":a(b.name);
break;case "array":for(var d=b.name.length;d--;)a(b.name[d]);break;default:n("Name passed is not of valid type.")}return this}}}(),s=function(){var a=k(g),b=a.height(),d=a.width(),h=a.scrollTop(),f=e.createElement("video"),c=function(){return f.requestFullScreen?{active:function(){return null!==e.fullscreenElement},element:function(){return e.fullscreenElement},enter:function(a){a.requestFullscreen()},exit:function(){e.exitFullscreen()}}:f.webkitRequestFullscreen?{active:function(){return null!==
e.webkitFullscreenElement},element:function(){return e.webkitFullscreenElement},enter:function(a){a.webkitRequestFullscreen()},exit:function(){e.webkitExitFullscreen()}}:f.mozRequestFullScreen?{active:function(){return null!==e.mozFullScreenElement},element:function(){return e.mozFullScreenElement},enter:function(a){a.mozRequestFullScreen()},exit:function(){e.mozCancelFullScreen()}}:f.msRequestFullscreen?{active:function(){return null!==e.msFullscreenElement},element:function(){return e.msFullscreenElement},
enter:function(a){a.msRequestFullscreen()},exit:function(){e.msExitFullscreen()}}:{active:function(){return!1},element:function(){},enter:function(){n("Fullscreen API is not supported.")},exit:function(){n("Fullscreen API is not supported.")}}}(),m=c.element(),p=c.active();a.off(".bolster.setWindowAttributes").on({"webkitfullscreenchange.bolster.setWindowAttributes mozfullscreenchange.bolster.setWindowAttributes fullscreenchange.bolster.setWindowAttributes MSFullscreenChange.bolster.setWindowAttributes":function(){m=
c.element();p=c.active();l.publish({topic:"fullscreenChange",data:{active:p,element:m}})},"load.bolster.setWindowAttributes":function(a){l.publish({topic:"windowLoad",data:{event:a,height:b,originalState:a.originalEvent.state,scrollTop:h,width:d}})},"resize.bolster.setWindowAttributes":function(){b=a.height();d=a.width();l.publish({topic:"windowResize",data:{height:b,width:d}})},"popstate.bolster.setWindowAttributes":function(a){l.publish({topic:"popstateChange",data:{event:a,originalState:a.originalEvent.state}})},
"scroll.bolster.setWindowAttributes":function(){h=a.scrollTop();l.publish({topic:"windowScroll",data:{scrollTop:h}})}});return{dimensions:function(){return{width:d,height:b}},enterFullscreen:function(a){return c.enter(a)},exitFullscreen:function(){return c.exit()},getFullscreenElement:function(){return m},height:function(){return b},isFullscreen:function(){return p},scrollTop:function(){return h},width:function(){return d},window:function(){return a}}}(),t=function(){var a=k(e),b=a.width(),d=a.height();
a.off(".bolster.setDocumentAttributes").on({"load.bolster.setDocumentAttributes":function(){l.publish({topic:"documentLoad",data:{width:b,height:d}})},"resize.bolster.setDocumentAttributes":function(){b=a.width();d=a.height();l.publish({topic:"documentResize",data:{width:b,height:d}})}});return{document:function(){return a},height:function(){return d},width:function(){return b}}}(),m={loadImg:function(a,b,d,e){if("function"===k.type(e)){var f=new Image;f.src=a.src;f.complete||4===f.readyState||"complete"===
f.readyState?e.call(a,{height:a.height,naturalHeight:f.naturalHeight||f.height,naturalWidth:f.naturalWidth||f.width,percentComplete:Math.floor(100*(b+1)/d),src:a.src,width:a.width}):(f.onload=function(){e.call(a,{height:a.height,naturalHeight:f.naturalHeight||f.height,naturalWidth:f.naturalWidth||f.width,percentComplete:Math.floor(100*(b+1)/d),src:a.src,width:a.width})},f.src=a.src)}},naturalDimensions:{height:function(a){var b=new Image;b.onload=function(){return b.naturalHeight||b.height};b.src=
a.src},width:function(a){var b=new Image;b.onload=function(){return b.naturalWidth||b.width};b.src=a.src}},getPage:function(){return Array.prototype.lastIndexOf?function(a){return a.substring(a.lastIndexOf("/")+1)}:function(a){a=a.split("/");return a[a.length-1].split("?")[0]}}()};k.extend({document:function(a){return a?t[a]():t.document()},page:function(a){return m.getPage(a||g.location.href)},pledge:function(a){if("function"===k.type(a))return(new Pledge).start(a);n("Must pass function into $.pledge.")},
...
a).removeClass(a):this.parent().find("."+a).removeClass(a);return this},imgLoad:function(a,b){var d=this.length;return b&&0<b?this.each(function(e){var f=this;g.setTimeout(function(){m.loadImg(f,e,d,a)},b*e)}):this.each(function(b){m.loadImg(this,b,d,a)})},naturalHeight:function(){return m.naturalDimensions.height(this.get(0))},naturalWidth:function(){return m.naturalDimensions.width(this.get(0))},unselectable:function(a){(a?this:this.add(this.find("*"))).attr({unselectable:"on"}).css({"-webkit-touch-callout":"none",
"-webkit-user-select":"none","-khtml-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"});return this},unstyle:function(a){switch(k.type(a)){case "string":return this.css(a,"");case "array":for(var b={},d=a.length;d--;)b[a[d]]="";return this.css(b);case "undefined":return this.removeAttr("style");default:return throwwError("Parameter passed in is not of appropriate type; processing aborted."),this}}})})(window,document,jQuery);
