...
scrollTop:function(){return f},width:function(){return e}}}();h.extend({publish:function(a){return l.publish(a)},subscribe:function(a){return l.subscribe(a)},supports:function(a){return r[a]()},unsubscribe:function(a){return l.unsubscribe(a)},window:function(a){return s[a]()}});h.fn.extend({active:function(a){return this.hasClass(a||"active")},activate:function(a,c){a=a||"active";return c?this.deactivate(a,c).addClass(a):this.deactivate(a).addClass(a)},deactivate:function(a,c){a=a||"active";c?this.parents(c).find("."+
a).removeClass(a):this.parent().find("."+a).removeClass(a);return this},imgLoad:function(a,c){var e=this.length;return c&&0<c?this.each(function(f){var b=this;d.setTimeout(function(){pluginFuncs.loadImg(b,f,e,a)},c*f)}):this.each(function(c){pluginFuncs.loadImg(this,c,e,a)})},unselectable:function(a){(a?this:this.add($self.find("*"))).attr({unselectable:"on"}).css({"-webkit-touch-callout":"none","-webkit-user-select":"none","-khtml-user-select":"none","-moz-user-select":"none","-ms-user-select":"none",
